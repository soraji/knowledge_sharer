...
<style scoped>
.pagination {display: inline-block;padding-left: 0;margin: 30px;border-radius: 4px;}
.pagination > li {display: inline;}
.pagination > li > a,
.pagination > li > span {position: relative;float: left;cursor: pointer;padding: 6px 12px;margin-left: -1px;line-height: 1.42857143;color: #5cbfd1;text-decoration: none;background-color: #ffffff;border: 1px solid #dddddd;}
...
.pagination > .active > span:focus {z-index: 3;color: #ffffff;cursor: default;background-color: #5cbfd1;border-color: #5cbfd1;}
