...
<script>
    ...
    export default {
        ...
        computed:{
            toticount:{
                get(){
                    return parseInt(this.$store.state.listB.toticount);
                },
                set(val){
                    this.$store.state.listB.toticount = val;
                }
            },
            whereIam(){
                return this.$store.state.listB.whereIam
            },
            countview:{
                get(){
                    return this.$store.state.listB.countview
                },
                set(val){
                    this.$store.state.listB.countview = parseInt(val);
                }
            },
        },
        mounted () {
