  ...
  <div>
    <table class="search2_top_table">
      <tr>
        <td></td>
        <td>
          <select class="selectDropDown" name="keyfield" id="keyfield" v-model="keyfield" style="">
            <option value="casename">사건명</option>
            <option value="caseno">사건번호</option>
          </select>
        </td>
        <td>
          <!-- <input type="text" name="keyword" id="keyword" v-model="keyword" v-on:keydown.enter.prevent='checkform'> -->
...
.search2_top_table tr td:nth-child(2){text-align: right;width:130px}
.search2_top_table tr td:nth-child(3){text-align: right;width:300px}
